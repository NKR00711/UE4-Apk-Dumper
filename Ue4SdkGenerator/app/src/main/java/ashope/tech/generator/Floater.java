...
public class Floater extends Service {
    ...
    public void Menu() {
        ...
        EspToggle(0, "Strings Dump", 0);
        EspToggle(0, "Objects Dump", 1);
        EspToggle(0, "SDK Dump (Full Dump)", 2);
        EspToggle(0, "SDK-W Dump (Selected Dump)", 3);

        AddText(1, "Made By Ascarre | Join @Ascarre_Hacks", 15, 1, "#FFFF0000");
        AddText(1, "1- Made SDK Generator for Android Mobile", 15, 1, "#FF13FF00");
        AddText(1, "2- Fixed Generator for 32 Bit Apk Files", 15, 1, "#FF13FF00");
        AddText(1, "3- No Need Offsets or User Input", 15, 1, "#FF13FF00");
    }
